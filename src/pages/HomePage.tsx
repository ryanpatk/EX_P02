      ...
      <div className="page-center">
        <div className="page-card">
          <header className="page-card-header">
            ...
            <p className="page-muted">Personal knowledge and bookmark management</p>
          </header>

          <div className="page-card-section">
            {session ? (
              <>
                <p className="page-muted">Welcome back, {session.user.email}</p>
                <button
                  type="button"
              ...
              <>
                ...
                <Link to="/auth/sign-up" className="btn-secondary w-full">
                  Create account
                </Link>
          ...
          <div className="page-divider">
            <p className="page-caption">
              Organize links, tags, and profiles in one focused workspace
            </p>
          </div>
        </div>
      </div>
