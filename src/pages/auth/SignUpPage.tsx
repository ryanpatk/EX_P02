        ...
        <div className="page-card">
          ...
          <div className="page-card-header">
            ...
            <p className="page-muted">
              Create your <span className="text-brand">EX_P02</span> account
            </p>
          </div>
          ...
          <div className="page-card-section text-center">
            <Link to="/auth/sign-in" className="text-sm text-gray-600 hover:text-black transition-colors">
              Already have an account? <span className="font-bold">Sign In</span>
            </Link>
          </div>

          {status && !status.includes("Creating") && !status.includes("GitHub") && (
            <div className={`p-3 border text-sm font-mono ${
